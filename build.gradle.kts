...
minecraft{
    ...
    mappings("parchment", "2021.12.13-nightly-SNAPSHOT-1.18.1")
...
sourceSets{
    create("generated")
    main.get().resources{
    srcDir(sourceSets["generated"].resources.srcDirs)
    }
}
